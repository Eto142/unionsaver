...
<head>
    <meta charset="utf-8" />
    <title>Union Saver Trust Bank | CREATE ACCOUNT</title>
  ...
  {{-- <div class="g-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}"></div>
    <script src="https://www.google.com/recaptcha/api.js" async defer></script> --}}
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the Union Saver Trust Bank <a href="#" class="text-primary">Terms of Use</a></p>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            </script> Powered by <i class="bx bx-check-shield text-success"></i> by Union Saver Trust Bank</p>
                    </div>
                </div>
...
<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
    <div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="https://Union Saver Trust Bank.com/user/logo.png" alt="" class="me-2" height="18">
