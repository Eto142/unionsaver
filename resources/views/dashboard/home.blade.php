      ...
      <div id="bankCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="carousel-advert d-flex align-items-center" style="min-height: 230px; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
              <div class="p-4 p-md-5 text-white">
                <h3 class="fw-bold mb-2">Bank Transfers</h3>
                <p class="mb-3">Send and receive funds with fast, reliable local and international transfers.</p>
                <button class="btn btn-outline-light btn-sm px-4 py-2">Transfer</button>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            <div class="carousel-advert d-flex align-items-center" style="min-height: 230px; background: linear-gradient(135deg, #ff758c 0%, #ff7eb3 100%);">
              <div class="p-4 p-md-5 text-white">
                <h3 class="fw-bold mb-2">Card Services</h3>
                <p class="mb-3">Request physical or virtual cards and enjoy secure transactions worldwide.</p>
                <button class="btn btn-outline-light btn-sm px-4 py-2">Request Now</button>
              </div>
            </div>
          </div>

          <!-- Premium Banking (Third) -->
          <div class="carousel-item">
            <div class="carousel-advert d-flex align-items-center" style="min-height: 230px; background: linear-gradient(135deg, #4e54c8 0%, #8f94fb 100%);">
              <div class="p-4 p-md-5 text-white">
                <h3 class="fw-bold mb-2">Premium Banking</h3>
                <p class="mb-3">Upgrade to our premium account for exclusive benefits and priority service.</p>
                <button class="btn btn-outline-light btn-sm px-4 py-2">Learn More</button>
              </div>
            </div>
          </div>
